...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://smpcolmek.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pijat.`,
        "logo": "https://smpcolmek.pages.dev/favicon.ico",
        "url": "https://smpcolmek.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://smpcolmek.pages.dev"
        ...
        "url": "https://smpcolmek.pages.dev",
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pijat.`,
        "image": "https://smpcolmek.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://smpcolmek.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://smpcolmek.pages.dev/?q={search_term}", 
